        ...
        <div className='flex w-full items-center justify-center p-4.5 '>
            ...
            <div className='hidden xl:flex justify-between items-center w-full'>
                ...
                <div className='flex h-9 gap-8'>
                    <a href="#how-it-works" className='text-text-muted font-normal text-base leading-6 tracking-[-0.31px] whitespace-nowrap'>О проекте</a>
                    <a href="#how-it-works-farmers" className='text-text-muted font-normal text-base leading-6 tracking-[-0.31px] whitespace-nowrap'>Как это работает</a>
                    <a href="#reviews" className='text-text-muted font-normal text-base leading-6 tracking-[-0.31px] whitespace-nowrap'>Отзывы</a>
